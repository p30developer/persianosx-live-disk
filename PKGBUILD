...
pkgver=r29.876fa8d
pkgrel=1
pkgdesc='persianosx Linux live session'
arch=('any')
url="https://gitlab.com/persianosx-linux/tools/persianosx-tools-livecd"
license=('GPL')
makedepends=('git')
source=("git+$url.git")
sha256sums=('SKIP')
...
pkgver() {
	cd "${srcdir}"/persianosx-tools-livecd || exit
